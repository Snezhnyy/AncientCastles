 ...
 * @author Snowdrop
 */
public class HealActionDragon extends GeneralAction{
    Image magicTile;
    ...
    public HealActionDragon(Room room, GameJFrame frame, Point cursorTile, UnitDescription ud, Point pos) {
        selected = true;
        magicTile = new ImageIcon("src" + File.separator + "projectone"+File.separator+"Image"+File.separator+"Cursor"+File.separator+"magicGP.png").getImage();
        activeUnit = ud;
    ...
    private void healAction(Point cursorTile, Room room) {
        if(attackMap[cursorTile.x][cursorTile.y] > -1 && room.graves[cursorTile.x][cursorTile.y] != null){
            activeUnit.heal(room.graves[cursorTile.x][cursorTile.y].maxHp);
